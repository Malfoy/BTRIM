...
int main(int argc, char ** argv){
	...
	uint64_t tiping(0),compactions(0),unitigRemoved(0),bubblePopped(0);
	string input(argv[1]);
	...
	if(bubbleRemoval){
		cout<<"Unitig removed according to coverage: "+intToString(unitigRemoved)<<endl;
	}
	cout<<"Tips removed: "+intToString(tiping)<<endl;
	cout<<"Buuble popped: "+intToString(bubblePopped)<<endl;
	cout<<"Compactions after cleaning: "+intToString(compactions)<<endl;
